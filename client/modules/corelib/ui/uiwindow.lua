...
function UIWindow:onDragMove(mousePos, mouseMoved)
  ...
  if parent and parent.scheduleRepaint then
    parent:scheduleRepaint(oldRect)
  end

  if self.scheduleRepaint then
    self:scheduleRepaint(self:getRect())
  end
end
