...
local pokemons = {
  {name = "Onix",  optionalLevel = 300, sex = SEX_FEMALE, nick = "", ball = "normal"},
  {name = "Hitmonchan", optionalLevel = 300, sex = SEX_FEMALE, nick = "", ball = "normal"},
  {name = "Hitmonlee",  optionalLevel = 300, sex = SEX_MALE,   nick = "", ball = "normal"},
  {name = "Onix",     optionalLevel = 300, sex = SEX_FEMALE, nick = "", ball = "normal"},
  {name = "Machamp",   optionalLevel = 320, sex = SEX_FEMALE, nick = "", ball = "normal"},
}
...
function onCreatureSay(cid, type, msg)
  ...
  if msgcontains(msg, 'hi') and focus == 0 and getDistanceToCreature(cid) <= 4 then
    ...
    talk_start = os.clock()
    conv = 1
    selfSay("Ola " .. getCreatureName(cid) .. ". Eu sou Bruno, da Elite dos 4. Preparado para o desafio?")
    return true
  end
