...
local pokemons = {
  ...
  {name = "Slowbro",  optionalLevel = 300, sex = SEX_MALE,   nick = "", ball = "normal"},
  {name = "Jynx",     optionalLevel = 300, sex = SEX_FEMALE, nick = "", ball = "normal"},
  {name = "Lapras",   optionalLevel = 320, sex = SEX_FEMALE, nick = "", ball = "normal"},
}
...
function onCreatureSay(cid, type, msg)
  ...
  if msgcontains(msg, 'hi') and focus == 0 and getDistanceToCreature(cid) <= 4 then
    ...
    talk_start = os.clock()
    conv = 1
    selfSay("Ola " .. getCreatureName(cid) .. ". Eu sou Lorelei, da Elite dos 4. Preparado para o desafio?")
    return true
  end
